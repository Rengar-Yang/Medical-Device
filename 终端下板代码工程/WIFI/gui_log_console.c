...
//支持换行
#define SUPORT_HUANGHANG    0

//更新行动画
#define SUPORT_NEW_LINE_AMI 0

//#define LINE_BUF_MAX  50
//#define LINE_SHOW_CNT 8 
//#define LINE_CHAR_CNT 17
//#define CHAR_HEIGHT   8
#define LINE_BUF_MAX  1
#define LINE_SHOW_CNT 1
#define LINE_CHAR_CNT 1
...
void console_log(unsigned short time_delay ,char* fmt,...)
{
	...
	{
		div_flag=All_str_length/LINE_CHAR_CNT;//检查是否需要换行
