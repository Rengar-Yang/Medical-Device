; Listing generated by Microsoft (R) Optimizing Compiler Version 19.30.30705.0 
	...
	TITLE	D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\build\Debug\obj\Table_NanumGothic_30_4bpp.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?glyphs_NanumGothic_30_4bpp@@3QBUGlyphNode@touchgfx@@B ; glyphs_NanumGothic_30_4bpp
PUBLIC	?unicodes_NanumGothic_30_4bpp@@3QBQBEB		; unicodes_NanumGothic_30_4bpp
EXTRN	?unicodes_NanumGothic_30_4bpp_0@@3QBEB:BYTE	; unicodes_NanumGothic_30_4bpp_0
msvcjmc	SEGMENT
...
__ABB900BB_Table_NanumGothic_30_4bpp@cpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
?glyphs_NanumGothic_30_4bpp@@3QBUGlyphNode@touchgfx@@B DD 00H ; glyphs_NanumGothic_30_4bpp
	DW	03fH
	DB	0bH
	DB	016H
	DB	015H
	...
	DB	00H
	ORG $+2
?unicodes_NanumGothic_30_4bpp@@3QBQBEB DD FLAT:?unicodes_NanumGothic_30_4bpp_0@@3QBEB ; unicodes_NanumGothic_30_4bpp
CONST	ENDS
...
PUBLIC	?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ ; getFont_NanumGothic_30_4bpp
...
EXTRN	?kerning_NanumGothic_30_4bpp@@3QBUKerningNode@touchgfx@@B:BYTE ; kerning_NanumGothic_30_4bpp
EXTRN	??_7type_info@@6B@:QWORD			; type_info::`vftable'
EXTRN	___security_cookie:DWORD
EXTRN	__tls_array:DWORD
EXTRN	__tls_index:DWORD
_BSS	SEGMENT
?NanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A DB 028H DUP (?) ; `getFont_NanumGothic_30_4bpp'::`2'::NanumGothic_30_4bpp
?$TSS0@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA DD 01H DUP (?) ; `getFont_NanumGothic_30_4bpp'::`2'::$TSS0
_BSS	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0
__ehfuncinfo$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT ??__FNanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ
text$yd	SEGMENT
??__FNanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ PROC ; `getFont_NanumGothic_30_4bpp'::`2'::`dynamic atexit destructor for 'NanumGothic_30_4bpp'', COMDAT
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET ?NanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
	...
	pop	ebp
	ret	0
??__FNanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ENDP ; `getFont_NanumGothic_30_4bpp'::`2'::`dynamic atexit destructor for 'NanumGothic_30_4bpp''
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ PROC ; getFont_NanumGothic_30_4bpp, COMDAT
; File D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\generated\fonts\src\Table_NanumGothic_30_4bpp.cpp
; Line 24
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	...
	mov	ecx, OFFSET __ABB900BB_Table_NanumGothic_30_4bpp@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 25
	mov	eax, DWORD PTR __tls_index
	mov	ecx, DWORD PTR fs:__tls_array
	mov	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR ?$TSS0@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	cmp	eax, DWORD PTR __Init_thread_epoch[edx]
	jle	SHORT $LN2@getFont_Na
	push	OFFSET ?$TSS0@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	call	__Init_thread_header
	add	esp, 4
	cmp	DWORD PTR ?$TSS0@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA, -1
	...
	push	0
	push	63					; 0000003fH
	push	OFFSET ?kerning_NanumGothic_30_4bpp@@3QBUKerningNode@touchgfx@@B ; kerning_NanumGothic_30_4bpp
	push	OFFSET ?unicodes_NanumGothic_30_4bpp@@3QBQBEB ; unicodes_NanumGothic_30_4bpp
	push	0
	push	0
	push	1
	push	4
	...
	push	30					; 0000001eH
	push	1
	push	OFFSET ?glyphs_NanumGothic_30_4bpp@@3QBUGlyphNode@touchgfx@@B ; glyphs_NanumGothic_30_4bpp
	mov	ecx, OFFSET ?NanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
	...
	push	OFFSET ??__FNanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ; `getFont_NanumGothic_30_4bpp'::`2'::`dynamic atexit destructor for 'NanumGothic_30_4bpp''
	call	_atexit
	add	esp, 4
...
$LN2@getFont_Na:
; Line 26
	mov	eax, OFFSET ?NanumGothic_30_4bpp@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
; Line 27
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0:
	push	OFFSET ?$TSS0@?1??getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	...
	int	3
	int	3
__ehhandler$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ:
	npad	1
	npad	1
	...
	mov	eax, OFFSET __ehfuncinfo$?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?getFont_NanumGothic_30_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ ENDP ; getFont_NanumGothic_30_4bpp
; Function compile flags: /Odtp /RTCsu /ZI
