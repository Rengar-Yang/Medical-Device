; Listing generated by Microsoft (R) Optimizing Compiler Version 19.30.30705.0 
	...
	TITLE	D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\build\Debug\obj\UnmappedDataFont.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__C2BD727F_FlashDataReader@hpp DB 01H
...
__63F85340_UnmappedDataFont@hpp DB 01H
__651B750F_UnmappedDataFont@cpp DB 01H
msvcjmc	ENDS
...
; _this$ = ecx
; File D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\generated\fonts\src\UnmappedDataFont.cpp
; Line 70
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __651B750F_UnmappedDataFont@cpp
...
; _this$ = ecx
; File D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\generated\fonts\include\fonts\UnmappedDataFont.hpp
; Line 100
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __63F85340_UnmappedDataFont@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 101
	mov	eax, DWORD PTR _this$[ebp]
...
; File D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\generated\fonts\include\fonts\ApplicationFontProvider.hpp
; Line 50
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __E4E33872_ApplicationFontProvider@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 51
	xor	eax, eax
; Line 52
