; Listing generated by Microsoft (R) Optimizing Compiler Version 19.30.30705.0 
	...
	TITLE	D:\学习\毕业设计\方案1_GFX+底板\官方例程\DISPLAY\TouchGFX\build\Debug\obj\Kerning_verdana_14_4bpp.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?kerning_verdana_14_4bpp@@3QBUKerningNode@touchgfx@@B ; kerning_verdana_14_4bpp
msvcjmc	SEGMENT
...
__E6FF236A_Kerning_verdana_14_4bpp@cpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
?kerning_verdana_14_4bpp@@3QBUKerningNode@touchgfx@@B DW 054H ; kerning_verdana_14_4bpp
	DB	0ffH
	ORG $+1
	DW	02dH
	DB	0ffH
